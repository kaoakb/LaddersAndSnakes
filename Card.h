...
public:
	...
	virtual void Save(ofstream& OutFile, int type, string file)=0;
	virtual void Load(ifstream& Infile, int type, string file)=0; // It is a virtual function (implementation depends on Card Type)
